...
const RecommendMultimedia = () => {
    ...
    const fileTypes = [
        {
            value: 'Video',
            label: 'Video Format (MP4, AVI, MKV, MOV, or WEBM)',
        },
        {
            value: 'Audio',
            label: 'Audio Format (MP3, WAV, AAC, OGG, or FLAC)',
        },
        {
            value: 'Image',
            label: 'Image Format (PNG, JPEG, GIF, BMP, or TIFF)',
        }
    ];
                ...
                <Stack direction="column" justifyContent="space-between" alignItems={isMobile ? 'center' : 'flex-start'} spacing={4}>
                    ...
                    <Stack direction={isMobile ? 'column' : 'row'} justifyContent="center" alignItems="flex-start" spacing={isMobile ? 2 : 10} sx={{ width: '100%' }}>
                        <Stack sx={{ width: { xs: '100%', md: '25%' }, flexGrow: 1 }}>
                            ...
                            <InputLabel htmlFor="FileType" sx={{
                                color: '#424242',
                                fontWeight: 'Medium',
                                fontFamily: 'Work Sans',
                                mt: 2
...
export default RecommendMultimedia;
